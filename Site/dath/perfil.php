            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active"><?php echo $_SESSION['usuario']; ?></a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="container">
                    <div class="media p-3">
                        ...
                        <div class="media-body my-auto">
                            <h2 style="font-size: 3rem" class="my-0"><?php echo $_SESSION['usuario']; ?></h2>
                            <p style="font-size: 2rem" class="my-0"><?php echo $_SESSION['email']; ?></p>
                            <p style="font-size: 1.5rem" class="my-0"><?php echo 'Id: ' . $_SESSION['id']; ?></p>
                        </div>
                    </div>
                </div>
            </div>
